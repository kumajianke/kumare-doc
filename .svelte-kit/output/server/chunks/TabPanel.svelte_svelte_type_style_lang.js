import { d as attributes, e as escape_html, f as attr, c as attr_class, l as stringify, i as spread_props, j as derived, g as ensure_array_like, n as store_set, h as head } from "./root.js";
...
function EditPage($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="edit-link svelte-1clzuxt" role="link" tabindex="0"><div class="edit-icon svelte-1clzuxt">`);
    Edit($$renderer2, {});
    $$renderer2.push(`<!----></div> <div class="edit-text svelte-1clzuxt">${escape_html(themeOptions.i18n?.suggestChangesToThisPage || DEFAULT_TEXT)}</div></div>`);
  });
}
function ActionButton($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { label, type = "", to, external = false } = $$props;
    $$renderer2.push(`<a${attr("href", external ? to : getPathFromBase(to))}${attr_class(`svp-action ${type ? `svp-action--${type}` : ""}`, "svelte-1vefpyc")}${attr("target", external ? "_blank" : "")}><span class="label svelte-1vefpyc">${escape_html(label)}</span> `);
    if (external) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div class="external-icon svelte-1vefpyc">`);
      External($$renderer2, {});
      $$renderer2.push(`<!----></div>`);
    } else {
      $$renderer2.push("<!--[-1-->");
...
function Feature($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class("feature-item svelte-1hgxs6g", void 0, { "clickable": link })} role="link" tabindex="0"><div class="flex justify-between items-start"><div class="icon svelte-1hgxs6g">`);
    if (!icon?.type) {
      $$renderer2.push("<!--[0-->");
      if (!noRandomIcon) {
        $$renderer2.push("<!--[0-->");
      ...
      $$renderer2.push("<!--[1-->");
      $$renderer2.push(`${html(icon.value)}`);
    } else if (icon.type === "iconify") {
      $$renderer2.push("<!--[2-->");
      IconifyIcon($$renderer2, spread_props([icon]));
    } else {
      $$renderer2.push("<!--[-1-->");
    }
    $$renderer2.push(`<!--]--></div> `);
    ...
    $$renderer2.push(`<!--]--></div> <div class="feature-title svelte-1hgxs6g">${escape_html(title)}</div> <div class="feature-desc svelte-1hgxs6g">${escape_html(description)}</div></div>`);
  });
}
function Home($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="home-page svelte-746hn1"><div class="title svelte-746hn1"><div class="intro svelte-746hn1"><div class="gradient-title svelte-746hn1">${escape_html(siteConfig2.title)}</div> <div class="description svelte-746hn1">${escape_html(siteConfig2.description)}</div> `);
    if (tagline) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div class="tagline svelte-746hn1">${escape_html(tagline)}</div>`);
    } else {
      $$renderer2.push("<!--[-1-->");
    }
    $$renderer2.push(`<!--]--></div> `);
    ...
    $$renderer2.push(`<!--]--></div> <div class="actions svelte-746hn1"><!--[-->`);
    const each_array = ensure_array_like(actions);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let action = each_array[$$index];
      ActionButton($$renderer2, spread_props([action]));
    }
    $$renderer2.push(`<!--]--></div> <div class="features svelte-746hn1"><!--[-->`);
    const each_array_1 = ensure_array_like(features);
    for (let i = 0, $$length = each_array_1.length; i < $$length; i++) {
      let fe = each_array_1[i];
      Feature($$renderer2, spread_props([fe, { i }]));
    }
...
function HeroImage($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    const { heroImage } = $$props;
    $$renderer2.push(`<div class="hero-image svelte-j46dh7"><img${attr("src", parseImageSrc(heroImage))}${attr("alt", siteConfig.title)} width="192" class="svelte-j46dh7"/></div>`);
  });
}
function LastUpdate($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    const { lastUpdate = "" } = $$props;
    const DEFAULT_TEXT = "Last update at:";
    if (lastUpdate) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div class="last-update svelte-amzpsn">${escape_html(themeOptions.i18n?.lastUpdateAt || DEFAULT_TEXT)}
...
function PageLayout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1k5y0yj", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>${escape_html(fm.title ? `${fm.title} - ${siteConfig.title}` : siteConfig.title)}</title>`);
      });
      $$renderer3.push(`<meta name="description"${attr("content", fm.description || siteConfig.description)}/>`);
    });
    if (layout === false) {
      $$renderer2.push("<!--[0-->");
      children?.($$renderer2);
      ...
      let defaultHeroImage = function($$renderer3) {
        if (fm.heroImage) {
          $$renderer3.push("<!--[0-->");
          HeroImage($$renderer3, { heroImage: fm.heroImage });
        } else {
          $$renderer3.push("<!--[-1-->");
        }
        $$renderer3.push(`<!--]-->`);
      ...
      if (!isHome()) {
        $$renderer2.push("<!--[0-->");
        $$renderer2.push(`<div pb-4="" class="theme-default--page-layout"><div class="content svelte-1k5y0yj">`);
        if (fm.title) {
          $$renderer2.push("<!--[0-->");
          $$renderer2.push(`<h1 class="page-title svelte-1k5y0yj">${escape_html(fm.title)}</h1>`);
        } else {
          $$renderer2.push("<!--[-1-->");
        }
        $$renderer2.push(`<!--]--> `);
        children?.($$renderer2);
        $$renderer2.push(`<!----> <div${attr_class("meta svelte-1k5y0yj", void 0, { "without-edit-link": !themeOptions.editLink })}>`);
        ...
        $$renderer2.push(`<!--]--> `);
        LastUpdate($$renderer2, { lastUpdate });
        $$renderer2.push(`<!----></div> `);
        {
          $$renderer2.push("<!--[-1-->");
        }
