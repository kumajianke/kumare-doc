...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/6ugo" | "/6ugo/admin" | "/6ugo/card" | "/6ugo/community" | "/6ugo/mechanism" | "/6ugo/need" | "/6ugo/note" | "/6ugo/note/lock" | "/6ugo/note/sklearn" | "/6ugo/note/sklearn/KNN" | "/6ugo/users" | "/rule" | "/rule/elysia";
		RouteParams(): {
		...
		Pathname(): "/" | "/6ugo" | "/6ugo/admin" | "/6ugo/card" | "/6ugo/community" | "/6ugo/mechanism" | "/6ugo/need" | "/6ugo/note/lock" | "/6ugo/note/sklearn" | "/6ugo/note/sklearn/KNN" | "/6ugo/users" | "/rule" | "/rule/elysia";
